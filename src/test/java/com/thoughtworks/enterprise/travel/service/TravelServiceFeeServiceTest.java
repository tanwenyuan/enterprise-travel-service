package com.thoughtworks.enterprise.travel.service;

import com.thoughtworks.enterprise.travel.builder.PaymentClientResponseBuilder;
import com.thoughtworks.enterprise.travel.builder.PaymentRequestDtoBuilder;
import com.thoughtworks.enterprise.travel.builder.ServiceFeeBuilder;
...
import com.thoughtworks.enterprise.travel.infrastructure.client.PaymentClient;
import com.thoughtworks.enterprise.travel.infrastructure.enums.ErrorCode;
import com.thoughtworks.enterprise.travel.infrastructure.repository.ServiceFeeRepository;
...
class TravelServiceFeeServiceTest extends ApplicationTestBase {
    ...
    void should_payment_service_fee_and_store_payment_result() {
        ...
        //then
        Assertions.assertEquals(PaymentStatus.PAID, paymentResponseDto.getPaymentStatus());
    }
    ...
    void should_throw_unpaid_exception_when_sevice_fee_unpaid() {
        ...
        //then
        Assertions.assertEquals(ErrorCode.TRANSACTION_NOT_PAID, exception.getErrorCode());
    }
}
