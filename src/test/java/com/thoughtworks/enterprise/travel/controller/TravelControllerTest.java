...
import com.thoughtworks.enterprise.travel.builder.PaymentResponseDtoBuilder;
import com.thoughtworks.enterprise.travel.enums.AccountType;
import com.thoughtworks.enterprise.travel.enums.PaymentStatus;
import com.thoughtworks.enterprise.travel.fixture.TravelServiceFeeServiceFixture;
...
class TravelControllerTest extends ApplicationTestBase {
    ...
    void should_return_payment_error_when_payment_service_is_unavailable() {
        ...
        MvcResult mvcResult = mockMvc.perform(post("/travel-orders/123/service-fee-request/confirmation")
                ...
                .andExpect(jsonPath("$.errorCode", is("REQUEST_THIRD_SYSTEM_ERROR")))
                .andExpect(jsonPath("$.message", is("调用三方接口异常,请稍后重试")))
                .andReturn();
